...
public class AirbusConTratteDTO {
	...
	public AirbusConTratteDTO() {

	}

	public AirbusConTratteDTO(Long id, String codice, String descrizione, LocalDate dataInizioServizio,
	...
	public Boolean getSovrapposizioni() {
	...
	public static AirbusConTratteDTO buildAirbusDTOFromModel(Airbus airbusModel, boolean includeTratte) {
		AirbusConTratteDTO result = new AirbusConTratteDTO(airbusModel.getId(), airbusModel.getCodice(), airbusModel.getDescrizione(),
	...
	public static List<AirbusConTratteDTO> createAirbusDTOListFromModelList(List<Airbus> modelListInput, boolean includeTratte) {
		return modelListInput.stream().map(airbusEntity -> {
			AirbusConTratteDTO result = AirbusConTratteDTO.buildAirbusDTOFromModel(airbusEntity, includeTratte);
			if (includeTratte)
